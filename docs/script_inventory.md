...
| `analysis/comparison_analysis_paper.rmd` | Consolidated paper comparison analysis | `results/tables/*_circ.csv`, `results/tables/*_enrichment.csv`, chondrocyte/cartilage app-ready RDS files | Manuscript figure PDF/PNG files and supplementary/summary CSVs in `results/publication_figures/` | None |
